        ...
        try:
            ...
            if session['current_question_index'] < len(session['generated_questions']):
                ...
                objections = [
                    ...
                    "Чому така висока ціна для такого простого інструменту?",
                    "А це не підробка оригінального бренду?",
                    "Чому в комплекті так мало насадок?",
                    "Я чув, що ця модель швидко ламається.",
                    "У сусідньому магазині така ж модель, але зі знижкою.",
                    "Чому немає кейсу в комплекті?",
                    "Це остання модель чи вже застаріла?",
                    "А де виробляють цей інструмент?",
                    "Чому акумулятор такий малопотужний?",
                    "Я не впевнений, що мені потрібно таке дороге обладнання.",
                    "Чому немає можливості оплатити частинами?",
                    "Я чув погані відгуки про цю модель.",
                    "Чому такий короткий гарантійний термін?",
                    "А якщо мені не сподобається - можна повернути?",
                    "Чому в іншому кольорі дорожче?",
                    "Це точно новий інструмент, а не відновлений?"
                ]
