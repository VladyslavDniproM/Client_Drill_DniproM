...
SITUATIONS = [
    ...
    {
        "id": 30,
        "description": "для сільради тример, щось акумуляторне — не хочемо бензину",
    ...
    {
        "id": 31,
        "description": "невеликий акумуляторний обприскувач для теплиці",
