...
SITUATIONS = [
    {
        ...
        "requirements": "легкий, зручний шуруповерт з хорошою ергономікою для тривалої роботи для збірки меблів",
        "avatar": "id13.png",
    ...
    },
    {
        ...
        "для ремонту електроніки, робота з дрібними кріпленнями"
    ...
    },
    {
        ...
        "requirements": "легка та зручна пилка для періодичних робіт для підрізки гілок",
        "avatar": "id25.png",
        "behavior": "пенсіонер, який сам доглядає сад",
        "correct_models": ["DSG-25H", "DSE-15T", "CS-12"],
        "wrong_models": ["NSG-62H", "DSE-24DS", "DCS-201BCDUAL"],
        "hints": [
            "Не хочеться важку техніку",
            "обрізати фруктові дерева в саду на дачі",
            "Беру в руки нечасто, навіть сказав би рідко",
            "Для гілок до 10 см",
            "Легкість та безпека у користуванні ланцюговою пилою — головне"
        ]
    },
    {
        "id": 26,
        "description": "ланцюгова пила",
        "requirements": "потужна ланцюгова пила, яка справиться з твердими породами",
        "avatar": "id26.png",
        ...
        "hints": [
            "Дрова для зими",
            "Для розпилювання товстих дерев для дров у приватному будинку",
            "Стовбури по 40–45 см",
            "Робота не щодня, але серйозна",
            "Бажаю мати бензинову ланцюгову пилу"
        ]
    },
    {
        "id": 27,
        "description": "ланцюгова пила",
        "requirements": "надійна, витривала, не бензинова, для розрізання перекриттів та брусів",
        "avatar": "id27.png",
        "behavior": "прораб будівництва",
        "correct_models": ["DSE-24DS", "DCS-201BCDUAL"],
        "wrong_models": ["DSG-25H", "DSE-15T", "NSG-45H"],
        "hints": [
            "Має витримувати інтенсивне використання",
            "Можемо працювати в приміщеннях",
            "Інколи працюємо на висоті",
            "Хочу електричну модель або акумуляторну",
            "Потрібен плавний пуск та аварійне гальмо для захисту"
        ]
    },
    {
        "id": 28,
        "description": "тример для дачі",
    ...
    },
    {
        ...
        "hints": [
            "Без бензину!",
            "нормальний та якісний треба",
            "Щоб тримав довго",
            "Буде працювати кілька людей",
            "Офіційна покупка, потрібна гарантія",
            "10 соток, але не будемо постійно праюцвати"
        ]
    },
    {
        "id": 31,
    ...
    },
    {
        ...
        "hints": [
            ...
            "Для приватного дому — щось універсальне",
    ...
    },
    {
        ...
        "hints": [
            ...
            "косіння навколо приватного будинку з газоном та деревами",
