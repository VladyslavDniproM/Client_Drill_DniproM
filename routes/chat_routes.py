...
def chat():
    ...
    # --- Stage 2: Вибір моделі ---
        ...
        Згенеруй 5 питань про **характеристики**, **зовнішню будову**, **призначення**, вартість інструменту. Питання має бути в одне речення, а також додавай якесь своє враження від відповіді на початку."""
...
"""
    ...
    Підтримуй контекст заперечення. Твоя відповідь повинна складатися рівно з одного речення (5–15 слів). Не повторюйся."""
        ...
        3. Логічна послідовність і побудова
        4. Наявність доказів, прикладів або логіки

        🔻 Оціни рівень відпрацювання заперечення за шкалою:
        ...
        """
                ...
                if rating == "ідеально":
                    objection_score = 10
                    reply = "Клієнт повністю задоволений консультацією!"
                elif rating == "гарно":
                    objection_score = 7
                    reply = "Клієнт задоволений консультацією."
                elif rating == "стандартно":
                    objection_score = 5
                    reply = "Клієнт отримав базову консультацію."
                elif rating == "сумнівно":
                    objection_score = 2
                    reply = "Клієнт отримав неповну консультацію."
                elif rating == "погано":
                    objection_score = 0
