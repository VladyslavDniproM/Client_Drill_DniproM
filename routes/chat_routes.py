...
def chat():
    ...
    """
                ...
                # 🔴 ОЦІНКА ДЛЯ STAGE 4 - ЗАПЕРЕЧЕННЯ
                    ...
                    ПРОАНАЛІЗУЙ відповіді продавця за такими критеріями та ВКАЖИ СУМУ двох балів від 0 до 6:
                    1. Чіткість відповідей (1-3 бали): Чи є відповіді продавця чіткими та відповідають запереченню? 
                    2. Вирішення проблеми (1-3 бали): Чи вирішує відповідь продавця заперечення?

                    ВАЖЛИВО: Сума двох балів має бути від 0 до 6. Наприклад:
                    - Відмінно: 3+3=6
                    - Добре: 3+2=5
                    - Задовільно: 2+2=4
                    - Слабко: 1+1=2
